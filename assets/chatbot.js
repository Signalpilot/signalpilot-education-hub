...
(function() {
  ...
  function searchLessons(query) {
    ...
    if (lowerQuery.includes('minimal')) results.push({ type: 'indicator', name: 'The Volume Oracle', lesson: 22, docs: 'https://docs.signalpilot.io/minimal-flow-v10/' });
  ...
  const knowledgeBase = {
    ...
    curriculum: {
      ...
      intermediate: "The Intermediate tier contains 15 lessons on market microstructure, advanced order flow, Signal Pilot indicators (Janus Atlas, Plutus Flow, The Volume Oracle), and professional frameworks. Complete the Beginner tier first!<br><br>📖 <a href='/intermediate.html'>View Intermediate Curriculum →</a><br>🚀 <a href='/curriculum/intermediate/13-bid-ask-spread-dynamics.html'>Start with Lesson #13 →</a>",
    ...
    indicators: {
      ...
      minimal: "The Volume Oracle is our volume strategy and regime detection system. It identifies market conditions and structure.<br><br>📚 <a href='https://docs.signalpilot.io/minimal-flow-v10/' target='_blank' rel='noopener'>View The Volume Oracle Documentation →</a><br>📖 <a href='/curriculum/intermediate/22-minimal-flow-regimes.html'>Read Lesson #22: The Volume Oracle Regimes →</a>",
    ...
    concepts: {
      ...
      regime: "Market regimes are different market conditions (trending, ranging, volatile, calm). Trade the regime, not just the signal!<br><br>📖 <a href='/curriculum/intermediate/22-minimal-flow-regimes.html'>Read Lesson #22: The Volume Oracle Regimes →</a>",
