# RSI & Harmonic Oscillator Trading Checklist

**From Lesson 5: RSI >70 Is Often a BUY Signal (Yes, Really)**

Use this checklist to interpret RSI correctly based on market regime using Harmonic Oscillator confluence and Volume Oracle.

---

## 📋 Pre-Trade: Identify Regime & RSI Context

- [ ] **Determine market regime (CRITICAL)**
  - Use Volume Oracle or EMA alignment (price above/below 50 EMA)
  - Trending: Price consistently above/below major EMAs
  - Ranging: Price chopping through EMAs, sideways structure
  - Volatile: Skip trade (too choppy for RSI)

- [ ] **Check RSI value and interpret by regime**
  - **TRENDING UPTREND:** RSI >50 = bullish bias, RSI >70 = momentum (stay long)
...
- [ ] **Look for divergence (warning signal only)**
  ...
  - Divergence alone is NOT entry signal (wait for structure break)

---

## ✅ Entry Criteria (All Must Be Met)

- [ ] Regime identified (trending or ranging via Volume Oracle or EMA)
...
**Stop Loss:**
- [ ] **Trending:** Stop below/above swing structure (not based on RSI)
- [ ] **Ranging:** Stop beyond range boundary (2-3% past support/resistance)
- [ ] Stop price: $________
- [ ] Position size: ________ (based on stop distance)

**Take Profit:**
- [ ] Target 1 (1.5R): $________ (next structure level)
- [ ] Target 2 (2.5R): $________ (HTF resistance/support)
- [ ] Target 3 (trailing): Let price action guide (don't exit just because RSI hits 70/30)
...
**Regime accuracy:**
- Did you correctly identify trending vs ranging? ________________________________________________
